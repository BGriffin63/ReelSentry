<?php
/* VM Sentinel — sanitized history export (spec §13.4, §18). SPDX-License-Identifier: MIT
...
if ($fmt === 'csv') {
    ...
    header('Content-Disposition: attachment; filename="vm-sentinel-history.csv"');
    echo vms_run('services/history-tool.sh', ['export-csv']);
} else {
    header('Content-Type: application/json');
    header('Content-Disposition: attachment; filename="vm-sentinel-history.json"');
